...
In order to validate this hypothesis I used `all_to_all` rule, that ensures a single connection between the input and all the neurons of the network. I got the results in (https://github.com/Igor10798/Internship/blob/master/first_network/validation/Vms.png && https://github.com/Igor10798/Internship/blob/master/first_network/validation/spikes.png VS https://github.com/Igor10798/Internship/blob/master/first_network/validation/Vms_alltoall.pmg && https://github.com/Igor10798/Internship/blob/master/first_network/validation/spikes_alltoall.png), which support the hypothesys I was testing.  

...
syn_dict_ex =   {"model": "stdp_synapse",
...
syn_dict_in =   {"model": "stdp_synapse",
                "alpha": {"distribution": "uniform", "low": alpha_min, "high": alpha_max},
...
"""
<===========================================>
<==== PLASTIC SYNAPSES WITH PULSE INPUT ====>
<===========================================>
"""
...
spikes1 = dmm1['senders']
ts1 = dmm1["times"]
plot1 = px.scatter(x=ts1, y=spikes1, labels={'x': 't', 'y': 'spikes 1 -plasticity pulse'})
plot1.show()

dmm2 = nest.GetStatus(spikeDet2, keys= "events")[0]
spikes2 = dmm2["senders"]
ts2 = dmm2["times"]
plot2 = px.scatter(x=ts2, y=spikes2, labels={'x': 't', 'y': 'spikes 2 -plasticity pulse'})
plot2.show()

dmmInh = nest.GetStatus(spikeDet_inh, keys= "events")[0]
spikes_inh = dmmInh["senders"]
ts_inh = dmmInh["times"]
plot3 = px.scatter(x=ts_inh, y=spikes_inh, labels={'x': 't', 'y': 'inh spikes -plasticity pulse'})
plot3.show()